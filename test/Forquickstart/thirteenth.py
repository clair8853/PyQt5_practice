...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        # Progress bar for showing loading progress
    ...
    def update_ui_after_data_loaded(self):
        ...
        self.progress_bar.setValue(100)  # 작업 완료
        self.statusbar.showMessage("Data loaded successfully.", 5000)  # 메시지 박스 대신 상태 표시줄 사용
...
class DEGAnalysisDialog(QDialog):
    ...
    def run_deg_analysis(self):
        ...
        if not self.selected_clusters or not self.selected_other_clusters:
            ...
            self.statusbar.showMessage("DEG Analysis completed successfully.", 5000)
    ...
    def save_deg_result(self):
        ...
        if 'rank_genes_groups' in self.adata.uns:            
            ...
            if filePath:
                ...
                self.statusbar.showMessage(f"Data saved: {filePath}", 5000)
        else:
